    ...
    >
      <div className='col-span-6 flex flex-col'>
        <div>
          ...
          <h2 className='w-full text-center font-bold sm:text-left text-2xl tracking-tight text-white lg:text-3xl xl:text-4xl'>
            {t('hero.heading')}
          </h2>
          <p className='w-full text-center sm:text-left mx-auto mt-2 text-sm lg:text-md xl:text-lg text-white mb-4'>
            {t('hero.subheading')}
          </p>
          <a
            href='#'
